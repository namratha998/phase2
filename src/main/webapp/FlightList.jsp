...
<body>
<br>
<a href=Home.jsp style="color:black;text-decoration:none;fontsize:35px;fontweight:bold;">Flight Booking</a>
<br><br>
<%
...
String connectionUrl = "jdbc:mysql://localhost:3306/flightbooking"; 
String dbName = "flightbooking"; 
String userId = "root"; 
String password = "namratha"; 
try { 
...
statement=connection.prepareStatement("select * from flights where source=? and destination=? and datef=?"); 
